...
const Color hintColor = Color(0xFFBCBCBC);
...
// زر إرفاق ملف المحاضرة (بإطار منقط)
// ملاحظة: لجعل الإطار منقط تماماً يفضل استخدام حزمة dotted_border
// هنا قمت بمحاكاة التصميم بشكل قريب جداً
Container(
...
width: 2,
style: BorderStyle.solid, // استبدليه بـ DottedBorder إذا أضفتِ الحزمة
),
),
child: Row(
