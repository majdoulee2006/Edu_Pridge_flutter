  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [IconButton(icon: const Icon(Icons.arrow_forward, color: Colors.black), onPressed: () => Navigator.pop(context))],
      ),
      body: Directionality(
        ...
        child: ListView(
          ...
          children: [
            _buildNotifCard("واجب أكاديمي", "أحمد محمد (طالب)", "تم تسليم واجب الرياضيات الجديد.", "منذ 15 دقيقة", Icons.book, const Color(0xFFFEF9E7), const Color(0xFFD4AC0D)),
            _buildNotifCard("إشعار إداري", "قسم الامتحانات", "تم تحديث جدول الامتحانات.", "أمس", Icons.calendar_today, const Color(0xFFF5EEF8), const Color(0xFF884EA0)),
