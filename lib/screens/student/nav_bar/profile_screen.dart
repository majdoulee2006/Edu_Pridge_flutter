    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('الملف الشخصي', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.bold)),
          centerTitle: true,
          actions: [
            TextButton(
              onPressed: () {},
              child: const Text('حفظ', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.bold, fontSize: 16)),
            ),
          ],
        ),
        body: Stack(
            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  _buildInfoCard([
                    _InfoRow(title: 'رقم الهاتف', value: '4567 123 050', icon: Icons.phone_android, isEditable: true),
                    _InfoRow(title: 'البريد الإلكتروني', value: 'ahmed.ali@institute.edu', icon: Icons.email, isEditable: true),
                  ]),
                  
                  _buildSectionTitle('البيانات الأكاديمية'),
                  _buildInfoCard([
                    _InfoRow(title: 'القسم', value: 'هندسة الحاسوب', icon: Icons.school, isEditable: false),
                    _InfoRow(title: 'السنة الدراسية / الفرع', value: 'السنة الثالثة', icon: Icons.account_tree_outlined, isEditable: false),
                  ]),

                  _buildSectionTitle('تفاصيل شخصية'),
                  _buildInfoCard([
                    _InfoRow(title: 'تاريخ الميلاد', value: '15 مايو 2002', icon: Icons.cake_outlined, isEditable: true),
                    _InfoRow(title: 'الجنس', value: 'ذكر', icon: Icons.people_outline, isEditable: false),
                  ]),
  ...
  Widget _buildProfileHeader() {
    return Column(
      children: [
        ...
        const Text('أحمد محمد علي', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.textDark)),
        ...
        Row(
          ...
          children: [
            ...
            _buildChip('ID: 202300159', const Color(0xFFFCF9D1), AppColors.textDark),
          ],
        )
      ],
    );
          ...
          return Column(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    Icon(entry.value.isEditable ? Icons.edit : Icons.lock_outline, 
                         color: entry.value.isEditable ? AppColors.accent : Colors.grey.shade400, size: 20),
                    const Spacer(),
                    Column(
                      ...
                      children: [
                        ...
                        Text(entry.value.value, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Icon(entry.value.icon, color: Colors.black87, size: 22),
                    ),
                  ],
                ),
              ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(Icons.chat_bubble_outline, 'المراسلات', false, () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const MessagesScreen())), badgeCount: 3),
        ],
      ),
    );
  }
...
class _InfoRow {
  final String title; final String value; final IconData icon; final bool isEditable;
  _InfoRow({required this.title, required this.value, required this.icon, required this.isEditable});
}