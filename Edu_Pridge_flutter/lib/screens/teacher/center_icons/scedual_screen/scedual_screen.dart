...
class _TeacherScheduleScreenState extends State<TeacherScheduleScreen> {
  ...
  List<Widget> _buildDayCards(BuildContext context) {
    ...
    final classes = (_scheduleData[dayKey] as List?)?.cast<Map<String, dynamic>>() ?? [];
            ...
            ListView(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Text(
                    days.isNotEmpty
                        ? "${selectedDayIndex == 0 ? 'اليوم' : days[selectedDayIndex]['name']}: ${(days[selectedDayIndex]['date'] as DateTime).day} ${_monthName((days[selectedDayIndex]['date'] as DateTime).month)}"
                        : '',
                    style: TextStyle(
